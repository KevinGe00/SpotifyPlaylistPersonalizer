...
app.post("/textboxuri", function(req, res){
  var rawuri = Object.keys(req.body)[0];
  targetPlaylisturi = rawuri.substring(rawuri.indexOf("playlist:") + 9);
  console.log(targetPlaylisturi);
});
var access_token;
var authHeader;
...
// app.post('/postselection', function (req, res) {
//   //recieves data from text input form 
...
//   res.render('postselection', { playListName: targetplayListName, playlistCover: targetPlaylistCover });
// })
...
app.get('/generateplaylist', function (req, res) {
  ...
  request.post(authOptions, function (error, response, body) {
    if (!error && response.statusCode === 200) {
      ...
      //global authetication header to avoid dxuplicates
